...
class Statistics:
    ...
    def __init__(self, helper):
        ...
        if helper.output:
            ...
            try:
                ...
                try:
                    pp = psutil.Process(self.procID).parent()
    ...
    def addMainColumns(self):
        ...
        Table.postSessionTasks['ErrFile']        = Task(LogProcessing.getErrFile, [], 'text', 1)
    ...
    def start(self):
        ...
        self.isCrashed = LogProcessing.parseLog(self.logFile)
    ...
    def getRuntimeStats(self):
        ...
        while self.tracingInProcess:
            try:
                lf, er = Stats.getLogFiles(self.procID)
                if lf != None and lf != "":
                    self.logFile = lf
                if er != None and er != "":
                    self.errFile = er
